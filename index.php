...
<?php if ($home_service_on_off == 1) : ?>
    <style>
        ...
        .service .row {
            display: flex;
            width: 100%; /* Double the width to accommodate duplicates */
            margin: 0;
        ...
        .service {
            width: 100%; /* Each item takes up 50% of the container */
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-md-4">
                        <div class="item">
                            <div class="photo"><img src="assets/uploads/<?php echo $row['photo']; ?>" width="250px" alt="<?php echo $row['title']; ?>"></div>
                            <h3>
                                <?php echo $row['title']; ?>
                            </h3>
                            <p>
    ...
    <div class="product pt_70 pb_70">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 additional-items">
                    <div class="headline">
                    ...
                    foreach ($result as $row) {
                    ?>
                        <div class="col-md-3 item all-products">
                            <div class="inner">
                                <div class="thumb">
                                    <div class="photo" style="background-image:url(assets/uploads/<?php echo $row['p_featured_photo']; ?>);">
                                    </div>
