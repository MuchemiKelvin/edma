...
foreach ($result as $row) {
    ...
    $home_all_product_on_off = $row['home_popular_product_on_off'];
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Home Page (How many all product?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_all_product_home" value="<?php echo $total_all_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="tab-pane" id="tab_6">
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">All Products Section </label>
                                        <div class="col-sm-4">
                                            <select name="home_all_product_on_off" class="form-control" style="width:auto;">
                                                <option value="1" <?php if ($home_all_product_on_off == 1) {
                                                                        echo 'selected';
                                                                    } ?>>On</option>
                                                <option value="0" <?php if ($home_all_product_on_off == 0) {
                                                                        echo 'selected';
                                                                    } ?>>Off</option>
                                            </select>
                                        </div>
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">All Products Title<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name=all_product_title" value="<?php echo $all_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">All Product SubTitle<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="all_product_subtitle" value="<?php echo $all_product_subtitle; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
